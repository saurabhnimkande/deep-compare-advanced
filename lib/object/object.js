...
const objectCompare = (one, two, parentOne, parentTwo) => {
  ...
  if (oneKeys.length !== twoKeys.length) {
    ...
    for (let keys in one) {
      ...
      let resultObject = checkObjects && !checkArrays && objectCompare(value1, value2, mergeParent1, mergeParent2);
      let resultArrays = checkArrays && (0, _array.arrayCompare)(value1, value2, mergeParent1, mergeParent2);
