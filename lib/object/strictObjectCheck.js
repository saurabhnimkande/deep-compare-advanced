...
var strictObjectCompare = function strictObjectCompare(one, two, parentOne, parentTwo) {
  ...
  if (oneKeys.length !== twoKeys.length) {
    ...
    for (var keys in one) {
      ...
      var resultObject = checkObjects && !checkArrays && strictObjectCompare(value1, value2, mergeParent1, mergeParent2);
      var resultArrays = checkArrays && (0, _strictArrayCheck.strictArrayCompare)(value1, value2, mergeParent1, mergeParent2);
